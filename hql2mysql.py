...
for number in range(len(strList)):
    ...
    if number == 0:
        headStr0 = strSpilt[-1].split(".")  # 切分成`  sdm_cro_patient_project_rel_opt_log_full_d`(
    ...
    if 0 < number < len(strList) - 1:
        ...
        if strSpilt[1] == "timestamp":
            writer2 = "  " + strSpilt[0] + " " + "timestamp NULL DEFAULT NULL COMMENT " + strSpilt[3]
            print(writer2)
        elif strSpilt[1] == "string":
            writer2 = "  " + strSpilt[0] + " " + "varchar(200) DEFAULT '' COMMENT " + strSpilt[3]
            print(writer2)
        elif strSpilt[1] == "int":
            writer2 = "  " + strSpilt[0] + " " + "int(10) DEFAULT NULL COMMENT " + strSpilt[3]
            print(writer2)
        elif strSpilt[1] == "bigint":
            writer2 = "  " + strSpilt[0] + " " + "int(10) DEFAULT NULL COMMENT " + strSpilt[3]
            print(writer2)
        elif strSpilt[1] == "decimal(10,2)":
            writer2 = "  " + strSpilt[0] + " " + "decimal(10,2) unsigned DEFAULT '0.00' COMMENT " + strSpilt[3]
            print(writer2)
        else:
